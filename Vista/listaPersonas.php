   ...
   <h3 class="text-center">Listado de personas</h3>
    <div class="row text-muted m-0">
       ...
       // print_r($listaTabla);
        ...
        ?>
        <table class="table table-dark table-striped text-center table-hover" cellspacing="0"
  width="100%">
            <thead>
                <tr>
            ...
            <tbody>
                <?php
                    ...
                    foreach ($listaTabla as $objTabla) { 
                        ...
                        echo '<td><a href="autosPersona.php?NroDni='.$objTabla->getNroDni().'" class="btn btn-success">Ver</a></td>';
